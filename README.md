I've redone some basic functions and made a more polished UI, running in nodejs, also added a point counter, the canvas is sized based on the window size at page load (start and end screen added)
```js
{
    author: {
      name: "Loïc Rico",
